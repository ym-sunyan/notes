        ...
        # for index, line in enumerate(url_lines):
            ...
            for key in combined_sorted_keys:
                if key in list(new_canvas_info):
                    if new_content == []:
                        # 通过判断当前页面的url是否为独立的url，来确定是否应该在markdown中生成一级目录结构
                        next_index = index + 1
...
if __name__=='__main__':
    # 微信读书MainV3("https://weread.qq.com/web/reader/cf132e10813ab92e9g018088kc81322c012c81e728d9d180", book_name="思辨力35讲：像辩手一样思考_test")
    微信读书MainV3("https://weread.qq.com/web/reader/214327005b6b3621437a4f5kc81322c012c81e728d9d180", book_name="赢者之心：华尔街英语创始人的幸福成功学_test")
    # 微信读书MainV3("https://weread.qq.com/web/reader/77e326b072922e9177e6cb1kc81322c012c81e728d9d180", book_name="对赌_test")
    微信读书MainV3("https://weread.qq.com/web/reader/f1e328e072710bfaf1e87e9k0aa32fc02bf0aa1883c60ae", book_name="明朝那些事儿_test")
